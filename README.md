...
![Print da Saída Computacional](Anexos/saidacomputacional.jpg)

## Cálculos Manuais
O desenvolvimento das 5 fases do processo de inferência fuzzy (Parte 1) encontra-se digitalizado no seguinte documento:
[Clique aqui para ver o PDF com os cálculos manuais](Anexos/calculos_a_mao.pdf)
